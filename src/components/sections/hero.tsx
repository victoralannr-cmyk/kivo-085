  ...
  return (
    <section id="home" className="py-24 sm:py-32 lg:py-40">
      <div className="container text-center">
        ...
        <div className="mt-10">
          <Button size="lg" className="w-[293px] h-[43px] bg-gradient-to-r from-[#19233A] via-[#AEB7C4] to-[#19233A] bg-[length:200%_auto] text-primary-foreground hover:scale-105 transition-transform duration-300 animate-pulse-glow">
            WhatsApp

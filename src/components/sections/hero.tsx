...
const HeroSection = () => {
  return (
    <section id="home" className="relative pt-64 pb-24 sm:pt-72 sm:pb-32 lg:pt-80 lg:pb-40 overflow-hidden">
      <div className="absolute top-0 left-0 right-0 h-full bg-[radial-gradient(ellipse_50%_50%_at_50%_-20%,#19233A,rgba(255,255,255,0))]"></div>
      <FloatingLogos />
      ...
      <div className="container text-center">
        ...
        <div className="mt-10">
          <Button size="lg" className="rounded-full bg-gradient-to-r from-[#1A237E] via-[#4285F4] to-[#1A237E] bg-[length:200%_auto] text-white transition-all duration-300 hover:brightness-110 btn-shine animate-gradient-flow" style={{animation: 'pulse-light 3s infinite'}}>

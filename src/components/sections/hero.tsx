...
const HeroSection = () => {
  return (
    <section id="home" className="relative pt-64 pb-24 sm:pt-72 sm:pb-32 lg:pt-80 lg:pb-40 overflow-hidden">
      <div className="absolute top-0 left-0 right-0 h-1/2 -z-10 bg-[radial-gradient(ellipse_50%_50%_at_50%_-20%,rgba(25,35,58,0.4),rgba(255,255,255,0))]"></div>
      <FloatingLogos />
      ...
      <div className="container text-center">
        ...
        <div className="mt-10">
          <Button size="lg" className="rounded-full bg-gradient-to-r from-blue-900 via-blue-700 to-blue-900 bg-[length:200%_auto] text-white transition-all duration-300 hover:scale-105 hover:brightness-110 animate-gradient-flow">

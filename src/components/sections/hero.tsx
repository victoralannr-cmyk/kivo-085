  ...
  return (
    <section id="home" className="py-24 sm:py-32 lg:py-40">
      <div className="container text-center">
        ...
        <div className="mt-10">
          <Button size="lg" className="w-[293px] h-[43px] bg-gradient-to-r from-primary via-slate-400 to-primary bg-[length:200%_auto] text-primary-foreground animate-pulse-glow hover:animate-none hover:scale-105 transition-all duration-300">
            Agendar
          </Button>
        </div>
      </div>
